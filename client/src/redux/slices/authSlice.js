...
export const getUserAddresses = createAsyncThunk("auth/getUserAddresses",
  async (userId, { rejectWithValue }) => {
    try {
  ...
  extraReducers: (builder) => {
    builder
      ...
      //.addCase(register.fulfilled, (state, action) => {
        ...
        alert("estoy en fulfilled - line 190")
        state.register.loading = false;
        state.register.error = false;
        state.register.success = true;
       
        //state.register.register = action.payload.register;
        //state.register.message = action.payload;
        alert("estoy en fulfilled - line 197,payload.message: "+payload.message)
